module ONIX
  class MarketRepresentation
    ...
    xml_accessor :agent_role, :from => "AgentRole", :as => Fixnum # should be a 2 digit num
    ...
    xml_accessor :market_publishing_status, :from => "MarketPublishingStatus", :as => Fixnum # should be a 2 digit num
  end
end
