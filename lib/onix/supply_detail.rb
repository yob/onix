module ONIX
  class SupplyDetail
    ...
    xml_accessor :supplier_role, :from => "SupplierRole", :as => Fixnum # should be a 2 digit num
    xml_accessor :supply_to_country, :from => "SupplyToCountry"
    xml_accessor :supply_to_territory, :from => "SupplyToTerritory"
    xml_accessor :availability_status_code, :from => "AvailabilityStatusCode", :as => Fixnum # should be a 2 digit num
    xml_accessor :product_availability, :from => "ProductAvailability", :as => Fixnum # should be a 2 digit num
